...
public class employees extends javax.swing.JInternalFrame {
    ...
    public static void filltable(){
        tb = Connect.FillTable("SELECT id, username, nom, prenom, role, specialite FROM users");
    ...
    adduserbtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hospitalSys/images/icons8-add.png"))); // NOI18N
    ...
    edituserbtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hospitalSys/images/icons8-edit.png"))); // NOI18N
    ...
    deletebtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hospitalSys/images/icons8-delete_bin.png"))); // NOI18N
    ...
    private void deletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtnActionPerformed
        ...
        if (selectedOption == JOptionPane.YES_OPTION){
            boolean isDone = Connect.AMS_request("DELETE FROM users WHERE id = "+id);
            if (isDone){
