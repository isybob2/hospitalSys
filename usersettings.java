...
public class usersettings extends javax.swing.JInternalFrame {
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        ResultSet rs = Connect.Select_request("SELECT * FROM "+TABLE_NAME+" WHERE id = +"+userIndex);
        try {
            while(rs.next()){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (OldPass.equals(InputedOldPass)){
            boolean isDone = Connect.AMS_request("UPDATE "+TABLE_NAME+" SET password = '"+NewPass+"' where id ="+String.valueOf(userIndex));
